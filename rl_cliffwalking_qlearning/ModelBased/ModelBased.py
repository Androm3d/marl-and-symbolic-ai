...
def main():
    ...
    params = {
        'gamma': [0.9, 0.95, 0.99],
        'num_trajectories': [10000, 5000, 1000],
    ...
    param_combinations = list(ParameterSampler(params, n_iter=n_combinations, random_state=1))
    ...
    with open('fractional_results.csv', 'w', newline='') as csvfile:
        ...
        csv_writer.writerow(['gamma', 'num_trajectories', 'finish_reward', 
                            ...
                            'avg_elapsed_time', 'std_training_time_per_sample', 'avg_steps', 'eval_std_steps','finish_percent'])
        ...
        for combo in param_combinations:
            ...
            for _ in range(3):
                ...
                training_times.append(end - start)  # Store each repetition's time
            ...
            csv_writer.writerow([
                ...
                np.std(training_times),  # Std over 3 runs
                BIGstep_average / 3,
                np.std(successful_steps),
                n_successful / (NUM_EPISODES*3) # Finish percentage
            ])
